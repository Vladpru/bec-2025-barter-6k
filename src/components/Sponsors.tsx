...
const Sponsors = () => {
  return (
    <section className="container">
      <h2 className="text-center text-bec text-2xl 580px:text-3xl 700px:text-5xl font-extrabold mb-20 4xl:mb-25 uppercase">
        Нас підтримали
      </h2>
      <div className="flex flex-col gap-8 justify-center items-center px-1">
        ...
        <div className="grid grid-cols-2 gap-5 600px:gap-40 max-w-[400px] justify-items-center w-full">
